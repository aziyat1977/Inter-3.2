    ...
    <div className="w-full h-full flex flex-col items-center justify-center text-center relative overflow-hidden p-4">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 md:gap-16 w-full max-w-[90vw]">
        <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="p-6 bg-neon-cyan/10 dark:bg-neon-cyan/20 rounded-full border-2 border-neon-cyan text-neon-cyan shadow-[0_0_50px_rgba(0,243,255,0.3)]"
        >
            <Target size="8vmin" />
        </motion.div>
        ...
        <motion.div
            ...
            className="bg-white/60 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 p-6 md:p-10 rounded-2xl max-w-4xl shadow-xl"
        >
            <div className="flex flex-col gap-2">
                <span className="opacity-50 uppercase tracking-widest text-[1.5vmin] text-neon-cyan">Definition</span>
                <p className="font-sans text-[3vmin] md:text-[4vmin] leading-tight text-slate-800 dark:text-white">
