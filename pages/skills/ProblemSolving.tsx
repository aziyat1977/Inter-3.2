    ...
    <div className="w-full h-full flex flex-col items-center justify-center text-center relative overflow-hidden p-4">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 md:gap-16 w-full max-w-[90vw]">
        ...
        <motion.div
            ...
            className="bg-purple-900/10 backdrop-blur-sm border border-purple-500/20 p-6 md:p-10 rounded-2xl max-w-4xl shadow-xl"
        >
             <div className="flex flex-col gap-2">
                <span className="opacity-50 uppercase tracking-widest text-[1.5vmin] text-purple-400">Definition</span>
